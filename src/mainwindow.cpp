    ...
    started(false)
{
    ...
    passGame = new QGraphicsPixmapItem();
    passGame->setPixmap(QPixmap(":/number/gj.png").scaled(300,300));
    passGame->setPos(100,this->height()/6);
    passGame->setZValue(100);

    ScoreBoard = new QGraphicsPixmapItem();
    ScoreBoard->setPixmap(QPixmap(":/number/score.png").scaled(100,50));
    ScoreBoard->setPos(600,10);
...
void MainWindow::showEvent(QShowEvent *)
{
    ...
    Digits->setPos(this->width()-160,10);
    Tens->setPos(this->width()-190,10);
    Hundreds->setPos(this->width()-220,10);

    gDigits = new MyScoreShow();
    gTens = new MyScoreShow();
    gHundreds = new MyScoreShow();
    gDigits->showResult(goalScore%10);
    gDigits->setZValue(10);
    gTens->showResult((goalScore%100)/10);
    gTens->setZValue(10);
    gHundreds->showResult(goalScore/100);
    gHundreds->setZValue(10);
    scene->addItem(gDigits);
    scene->addItem(gTens);
    scene->addItem(gHundreds);
    gDigits->setPos(this->width()-40,10);
    gTens->setPos(this->width()-70,10);
    gHundreds->setPos(this->width()-100,10);
    // Add the Bird count
    bird_count = new MyScoreShow();
    bird_count->showResult(birdcount);
    bird_count->setZValue(10);
    scene->addItem(bird_count);
    bird_count->setPos(120,20);
    ...
    // Add the slash
    QGraphicsPixmapItem *slash = new QGraphicsPixmapItem();
    slash->setPixmap(QPixmap(":/number/slash.png").scaled(30,40));
    scene->addItem(slash);
    slash->setPos(this->width()-130,10);
